...
EOF;
    ...
    private function compileDynamicRoutes(RouteCollection $collection, int $chunkLimit): array
    {
        ...
        foreach ($perModifiers as [$modifiers, $routes]) {
            ...
            set_error_handler(function ($type, $message): void { throw str_contains($message, $this->signalingException->getMessage()) ? $this->signalingException : new \ErrorException($message); });
